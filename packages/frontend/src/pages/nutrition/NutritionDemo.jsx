    ...
    <div className="min-h-screen bg-white">
      ...
      <main className="max-w-6xl px-4 py-10 mx-auto">
        ...
        <section className="max-w-3xl mx-auto text-center">
          ...
          <div className="grid grid-cols-1 gap-4 mt-8 sm:grid-cols-3">
            <div className="p-4 bg-white border rounded-xl border-emerald-200/70">
              <h3 className="text-sm font-semibold text-gray-900">Nhận diện món</h3>
              <p className="mt-1 text-xs text-gray-600">Ảnh → tên món ăn, top dự đoán.</p>
            </div>
            <div className="p-4 bg-white border rounded-xl border-emerald-200/70">
              <h3 className="text-sm font-semibold text-gray-900">Tính calo & macro</h3>
              <p className="mt-1 text-xs text-gray-600">Theo khẩu phần, quy đổi ra P/C/F.</p>
            </div>
            <div className="p-4 bg-white border rounded-xl border-emerald-200/70">
              <h3 className="text-sm font-semibold text-gray-900">Cá nhân hoá mục tiêu</h3>
              <p className="mt-1 text-xs text-gray-600">Theo cân nặng, mục tiêu, sở thích.</p>
            </div>
          </div>
        ...
        <section className="max-w-5xl mx-auto mt-16">
          <h2 className="text-xl font-semibold text-gray-900">Quy trình sử dụng</h2>
          <div className="grid grid-cols-1 gap-6 mt-6 md:grid-cols-2">
            {/* B1: Tải ảnh */}
            <div className="p-5 bg-white border rounded-2xl border-emerald-200/70">
              <div className="flex items-start justify-between">
                <h3 className="text-base font-semibold text-gray-900">Bước 1 — Tải ảnh món ăn</h3>
                <span className="px-2 py-0.5 text-xs rounded-full bg-emerald-50 text-emerald-700 ring-1 ring-emerald-200">Ảnh</span>
              </div>
            ...
            <div className="p-5 bg-white border rounded-2xl border-emerald-200/70">
              <div className="flex items-start justify-between">
                <h3 className="text-base font-semibold text-gray-900">Bước 2 — Nhận diện món ăn</h3>
                <span className="px-2 py-0.5 text-xs rounded-full bg-emerald-50 text-emerald-700 ring-1 ring-emerald-200">Dự đoán</span>
              </div>
              <p className="mt-2 text-sm leading-6 text-gray-700">
            ...
            <div className="p-5 bg-white border rounded-2xl border-emerald-200/70">
              <div className="flex items-start justify-between">
                <h3 className="text-base font-semibold text-gray-900">Bước 3 — Điều chỉnh khẩu phần</h3>
                <span className="px-2 py-0.5 text-xs rounded-full bg-emerald-50 text-emerald-700 ring-1 ring-emerald-200">Khẩu phần</span>
              </div>
              <p className="mt-2 text-sm leading-6 text-gray-700">
            ...
            <div className="p-5 bg-white border rounded-2xl border-emerald-200/70">
              <div className="flex items-start justify-between">
                <h3 className="text-base font-semibold text-gray-900">Bước 4 — Thành phần dinh dưỡng</h3>
                <span className="px-2 py-0.5 text-xs rounded-full bg-emerald-50 text-emerald-700 ring-1 ring-emerald-200">Macro</span>
              </div>
              <p className="mt-2 text-sm leading-6 text-gray-700">
            ...
            <div className="p-5 bg-white border rounded-2xl border-emerald-200/70">
              <div className="flex items-start justify-between">
                <h3 className="text-base font-semibold text-gray-900">Bước 5 — Cá nhân hoá mục tiêu</h3>
                <span className="px-2 py-0.5 text-xs rounded-full bg-emerald-50 text-emerald-700 ring-1 ring-emerald-200">Mục tiêu</span>
              </div>
              <p className="mt-2 text-sm leading-6 text-gray-700">
              ...
              <div className="mt-4 overflow-hidden border-2 border-dashed rounded-xl border-emerald-200">
                <div className="flex items-center justify-center w-full h-48 bg-emerald-50/40 text-emerald-600">
                  <span className="text-sm">Khung ảnh 5: Cá nhân hoá</span>
                </div>
              </div>
            </div>
            ...
            <div className="p-5 bg-white border rounded-2xl border-emerald-200/70">
              <div className="flex items-start justify-between">
                <h3 className="text-base font-semibold text-gray-900">Bước 6 — Gợi ý thực đơn</h3>
                <span className="px-2 py-0.5 text-xs rounded-full bg-emerald-50 text-emerald-700 ring-1 ring-emerald-200">Thực đơn</span>
              </div>
              <p className="mt-2 text-sm leading-6 text-gray-700">
              ...
              <div className="mt-4 overflow-hidden border-2 border-dashed rounded-xl border-emerald-200">
                <div className="flex items-center justify-center w-full h-48 bg-emerald-50/40 text-emerald-600">
                  <span className="text-sm">Khung ảnh 6: Thực đơn mẫu</span>
                </div>
              </div>
            </div>
            ...
            <div className="p-5 bg-white border rounded-2xl border-emerald-200/70">
              <div className="flex items-start justify-between">
                <h3 className="text-base font-semibold text-gray-900">Bước 7 — Danh sách mua sắm</h3>
                <span className="px-2 py-0.5 text-xs rounded-full bg-emerald-50 text-emerald-700 ring-1 ring-emerald-200">Shopping</span>
              </div>
              <p className="mt-2 text-sm leading-6 text-gray-700">
              ...
              <div className="mt-4 overflow-hidden border-2 border-dashed rounded-xl border-emerald-200">
                <div className="flex items-center justify-center w-full h-48 bg-emerald-50/40 text-emerald-600">
                  <span className="text-sm">Khung ảnh 7: Shopping list</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <section className="max-w-4xl p-5 mx-auto mt-16 border rounded-2xl border-emerald-200/70 bg-emerald-50/30">
          <h2 className="text-xl font-semibold text-gray-900">Bảo mật & nguồn dữ liệu</h2>
          <p className="mt-2 text-sm leading-6 text-gray-700">
        ...
        <section className="max-w-3xl mx-auto text-center mt-14">
          <button
            ...
            className="px-6 py-3 text-sm font-semibold text-white rounded-full bg-emerald-600 hover:bg-emerald-700 focus:outline-none focus:ring-2 focus:ring-emerald-400"
          >
            {isAuthenticated ? "Bắt đầu với Nutrition AI" : "Đăng nhập để bắt đầu"}
          </button>
