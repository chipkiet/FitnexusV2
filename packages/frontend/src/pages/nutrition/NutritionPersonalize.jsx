  ...
  const submit = async () => {
    try {
      ...
      const msg =
        ...
        e?.message ||
        "Không thể tạo kế hoạch dinh dưỡng";
      setError(msg);
    } finally {
      setLoading(false);
    }
      ...
      <div ref={containerRef} className="fc-container">
        ...
        <div className="fc-card">
          <div className="fc-header">
            ...
            <p className="fc-sub">
              Chọn mục tiêu và mô tả ngắn gọn để AI gợi ý kế hoạch ăn uống.
            </p>
          </div>
          ...
          <div className="fc-grid">
            ...
            <div className="fc-col">
              ...
              <div style={{ display: "flex", gap: 10, marginTop: 10 }}>
                ...
                >
                  Quay lại Nutrition AI
                </button>
              </div>
              {loading && (
                <div className="fc-loading" style={{ marginTop: 10 }}>
                  Đang tạo kế hoạch…
                </div>
              )}
              {error && (
                <div className="fc-error" style={{ marginTop: 10 }}>
                  {error}
                </div>
              )}
            </div>
