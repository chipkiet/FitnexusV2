...
export default function WorkoutRun() {
  ...
  const handleEndSession = async () => {
    ...
    try {
      ...
      alert(
        e?.response?.data?.message || e?.message || "Không thể kết thúc buổi"
      );
    }
  };
                ...
                <div className="space-y-6">
                  ...
                  <div className="sticky p-6 bg-white shadow-lg top-6 rounded-2xl">
                    ...
                    <div className="relative mb-8">
                      <div
                        className={`font-mono text-8xl font-bold text-center tabular-nums transition-colors ${
                    ...
                    <div className="flex justify-center mb-6">
                      {!running ? (
                        <button
                          className="flex items-center justify-center w-full gap-3 px-8 py-4 text-lg font-semibold text-white transition-all transform bg-blue-500 shadow-lg rounded-xl hover:bg-blue-500 hover:scale-105"
                    ...
                    <div className="space-y-3">
                      <button
                        className="flex items-center justify-center w-full gap-3 px-6 py-4 text-lg font-semibold text-white transition-all transform bg-green-500 shadow-md rounded-xl hover:bg-green-400 hover:scale-105"
